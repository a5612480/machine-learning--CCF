...
#读入停用词表来删除停用词
stopwords = pd.read_csv('d://四川大学机器智能实验室停用词库.txt',index_col=False,sep='\t',quoting=3,names=['stopword'],encoding='utf-8')
...
stopwords_test = pd.read_csv('d://四川大学机器智能实验室停用词库.txt',index_col=False,sep='\t',quoting=3,names=['stopword'],encoding='utf-8')
